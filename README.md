...
A run leaves one folder: `Output.xlsx` with four sheets - what was read, and what the organisation's model says of the code - and `_audit/Audit_Log.xlsx`, the record of the run: every step, every record and every exchange with the model.
